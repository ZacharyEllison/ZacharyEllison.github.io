...
date: 2026-03-27
lead: "a guide for sourdough basics I wrote for my sister"
# tag:
# -   writing
# -   recipe
---
...
When given the right environment, the yeast culture will happily reproduce and inflate dough with carbon dioxide - like baking soda or instant yeast but this one is _wild_

> [!DANGER] Important! Make sure it isn't in an airtight container! It needs to release gasses or else you made a BOMB
...
- add 50g flour and 50g water 
	- the water should be room temperature, _and never more than 100ºF_
...
After the first two-three days you'll see _some_ activity, bubbles of gas showing up in your slurry.
Usually this happens early as random non-yeast bacteria live and die. Keep going. 

When you regularly see the bubbles coming, rising the starter in the jar and then deflating once a day, you have created a living, established, _wild yeast colony_
...
>[!WARNING] The only natural predator to a starter is mold. 
> If you see orange or pink on your starter, it's dead Jim. In these cases it's often best to start over. But you _could_ dig out some from the bottom to save it.

>[!INFO] This goes for the jar and spoons too!
...
> [!INFO] Just a warning it takes about 24 hours 
...
> [!TIP]- All purpose flour is great, so is bread flour
...
> But don't use 100% rye, it just won't work ¯\\_(ツ)_/¯ 

## Bulk Fermentation

The fun part

> [!TODO] wash your hands and keep your sleeves up 
...
once it's all mixed an has sat, you're going to _fold_ 4-5 times over a period of about 5 hours.
...
After it has a good long rest, you can start _the final countdown_
...
With one, it _may_ add some neat lines. It's not necessary.
...
> [!TIP]  You can put the boule in the fridge covered or uncovered, but I recommend uncovered. It ends up being _much_ easier to handle when its dried out on the surface level overnight in the fridge.

## The Bake

When the next day comes, and you're getting ready to bake, go preheat the oven to _REALLY HOT like **475ºF-500ºF_** 

This also takes a long time so don't pull out the dough _quite_ yet.
...
> [!NOTE] without a dutch oven, you'll want to have a pan with a bunch of ice to put in the bottom of the oven to give your dough moisture.
...
Get a single razor blade and _score_ or slice about a half inch deep straight from top to bottom, dragging at a mostly horizontal angle so the dough doesn't drag along the blade much.
...
> [!tip] If you're using a dutch oven, make sure you have enough parchment paper to keep the dough from touching the walls of the dutch oven.
